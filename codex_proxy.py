...
def main() -> int:
    ...
    ap.add_argument("--manager-ws", default=os.environ.get("CODEX_MANAGER_WS") or "ws://127.0.0.1:8765")
    ap.add_argument("--proxy-id", default=os.environ.get("PROXY_ID") or "")
    ap.add_argument("--token", default=os.environ.get("PROXY_TOKEN") or "")
